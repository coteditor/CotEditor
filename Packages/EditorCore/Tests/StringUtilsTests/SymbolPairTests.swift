...
struct SymbolPairTests {
    ...
    @Test func rangeOfSymbolPairWithoutBackslashEscaping() {
        ...
        let backslashRange = string.rangeOfSymbolPair(at: beginIndex, candidates: SymbolPair.braces, escapeCharacter: "\\")
    ...
    @Test func rangeOfSymbolPairWithDoubleDelimiterEscaping() {
        ...
        let openingRange = string.rangeOfSymbolPair(at: string.index(0), candidates: quotes, escapeCharacter: "'")
        let closingRange = string.rangeOfSymbolPair(at: string.index(5), candidates: quotes, escapeCharacter: "'")
        let escapedRange = string.rangeOfSymbolPair(at: string.index(2), candidates: quotes, escapeCharacter: "'")
    ...
    @Test func rangeOfSymbolPairWithDoubleDelimiterEscapingAsymmetric() {
        ...
        let openingRange = string.rangeOfSymbolPair(at: string.index(0), candidates: brackets, escapeCharacter: "]")
        let closingRange = string.rangeOfSymbolPair(at: string.index(5), candidates: brackets, escapeCharacter: "]")
        let escapedRange = string.rangeOfSymbolPair(at: string.index(2), candidates: brackets, escapeCharacter: "]")
    ...
    @Test func samePairBackslashVsNone() {
        ...
        let backslashRange = string.rangeOfSymbolPair(at: string.index(0), candidates: quotes, escapeCharacter: "\\")
        let noneRange = string.rangeOfSymbolPair(at: string.index(0), candidates: quotes)
