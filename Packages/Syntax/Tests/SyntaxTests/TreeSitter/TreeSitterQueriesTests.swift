...
struct TreeSitterQueriesTests {
    ...
    @Test func capturesIgnoreQuotedAndIdentifierAtSigns() {
        
        let captures = Self.captures(in: #"prefix@value "@ignored" user@example.com @keyword @string.quoted"#)
        
        #expect(captures == ["keyword", "string.quoted"])
    }
