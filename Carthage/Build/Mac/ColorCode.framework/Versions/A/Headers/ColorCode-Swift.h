...
/**
  ...
  NSColor
  \endcode object using the given hex color code. Or returns \code
  nil
  \endcode if color code is invalid.
  Example usage:
  \code
...
/**
  Creates and returns a \code
  <String, NSColor>
  \endcode paired dictionary represents all keyword colors specified in CSS3.
...
+ (NSDictionary<NSString *, NSColor *> * _Nonnull)stylesheetKeywordColors;
@end
...
/**
  Creates and returns a \code
  NSColor
  \endcode object using the given opacity and HSL components.
...
/**
  ...
  If NULL is passed in as an argument, the method doesn’t set that value. This method works only with objects representing colors in the \code
  NSCalibratedRGBColorSpace
  \endcode or \code
  NSDeviceRGBColorSpace
  \endcode color space. Sending it to other objects raises an exception.
...
/**
  ...
  Access this property only for colors in the \code
  NSCalibratedRGBColorSpace
  \endcode or \code
  NSDeviceRGBColorSpace
  \endcode color space. Sending it to other objects raises an exception.
