...
class StringCommentingTests: XCTestCase {
    ...
    func testInlineUncomment() {
        ...
        XCTAssertEqual("  //foo".rangesOfInlineDelimiter("//", spacer: "", ranges: [NSRange(0..<7)]), [])
        ...
        XCTAssertEqual(" //foo\n//bar".rangesOfInlineDelimiter("//", spacer: " ", ranges: [NSRange(0..<12)]), [NSRange(7..<9)])
    ...
    func testBlockUncomment() {
        ...
        XCTAssertEqual(" <-foo-> ".rangesOfBlockDelimiters(Pair("<-", "->"), spacer: "", ranges: [NSRange(0..<9)]), [])
        XCTAssertEqual(" <-foo-> ".rangesOfBlockDelimiters(Pair("<-", "->"), spacer: "", ranges: [NSRange(1..<7)]), [])
        XCTAssertEqual(" <-foo-> ".rangesOfBlockDelimiters(Pair("<-", "->"), spacer: "", ranges: [NSRange(1..<8)]), [NSRange(1..<3), NSRange(6..<8)])
