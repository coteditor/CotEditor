...
@MainActor final class StatusBarController: NSViewController {
    ...
    override func viewDidLoad() {
        ...
        self.view.setAccessibilityLabel(String(localized: "Status Bar", table: "Document", comment: "accessibility label"))
    }
