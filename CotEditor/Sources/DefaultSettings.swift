...
let DefaultSettings: [DefaultKey: AnyObject] = [
    ...
    .documentConflictOption: CEDocumentConflictOption.revert.rawValue,
    ...
    .encodingInOpen: CEAutoDetectEncoding,
    .saveUTF8BOM: false,
    ...
    .printColorIndex: CEPrintColorMode.blackWhite.rawValue,
    .printLineNumIndex: CELineNumberPrintMode.printNo.rawValue,
    .printInvisibleCharIndex: CEInvisibleCharsPrintMode.no.rawValue,
    .printHeader: true,
    .primaryHeaderContent: CEPrintInfoType.filePath.rawValue,
    .primaryHeaderAlignment: CEAlignmentType.alignLeft.rawValue,
    .secondaryHeaderContent: CEPrintInfoType.printDate.rawValue,
    .secondaryHeaderAlignment: CEAlignmentType.alignRight.rawValue,
    .printFooter: true,
    .primaryFooterContent: CEPrintInfoType.none.rawValue,
    .primaryFooterAlignment: CEAlignmentType.alignCenter.rawValue,
    .secondaryFooterContent: CEPrintInfoType.pageNumber.rawValue,
    .secondaryFooterAlignment: CEAlignmentType.alignCenter.rawValue,
