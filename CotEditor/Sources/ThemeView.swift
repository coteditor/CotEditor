...
private final class ThemeObject: ObservableObject {
    ...
    init(_ theme: Theme) {
        ...
        self._text = .init(initialValue: Color(theme.text.color))
        self._insertionPoint = .init(initialValue: Color(theme.insertionPoint.color))
        self._invisibles = .init(initialValue: Color(theme.invisibles.color))
        self._background = .init(initialValue: Color(theme.background.color))
        self._lineHighlight = .init(initialValue: Color(theme.lineHighlight.color))
        self._selection = .init(initialValue: Color(theme.selection.color))
        self._usesSystemSetting = .init(initialValue: theme.selection.usesSystemSetting)
        
        self._keywords = .init(initialValue: Color(theme.keywords.color))
        self._commands = .init(initialValue: Color(theme.commands.color))
        self._types = .init(initialValue: Color(theme.types.color))
        self._attributes = .init(initialValue: Color(theme.attributes.color))
        self._variables = .init(initialValue: Color(theme.variables.color))
        self._values = .init(initialValue: Color(theme.values.color))
        self._numbers = .init(initialValue: Color(theme.numbers.color))
        self._strings = .init(initialValue: Color(theme.strings.color))
        self._characters = .init(initialValue: Color(theme.characters.color))
        self._comments = .init(initialValue: Color(theme.comments.color))
