...
extension NSDocument {
    ...
    func presentErrorAsSheetSafely(_ error: some Error, synchronousWaiting waitSynchronously: Bool = false, recoveryHandler: RecoveryHandler? = nil) {
    ...
    func presentErrorAsSheet(_ error: some Error, recoveryHandler: RecoveryHandler? = nil) {
