...
class TextViewController: NSViewController, NSTextViewDelegate {
    ...
    deinit {
        ...
        UserDefaults.standard.removeObserver(self, forKeyPath: CEDefaultHighlightCurrentLineKey)
    ...
    override func viewDidLoad() {
        ...
        UserDefaults.standard.addObserver(self, forKeyPath: CEDefaultHighlightCurrentLineKey, options: .new, context: nil)
    ...
    override func observeValue(forKeyPath keyPath: String?, of object: AnyObject?, change: [NSKeyValueChangeKey : AnyObject]?, context: UnsafeMutablePointer<Void>?) {
        ...
        if keyPath == CEDefaultHighlightCurrentLineKey {
    ...
    func textView(_ textView: NSTextView, completions words: [String], forPartialWordRange charRange: NSRange, indexOfSelectedItem index: UnsafeMutablePointer<Int>?) -> [String] {
        ...
        if let syntaxWords = self.syntaxStyle?.completionWords where defaults.bool(forKey: CEDefaultCompletesSyntaxWordsKey) {
        ...
        if defaults.bool(forKey: CEDefaultCompletesStandartWordsKey) {
    ...
    private func highlightMatchingBrace(in textView: NSTextView) {
        ...
        guard UserDefaults.standard.bool(forKey: CEDefaultHighlightBracesKey) else { return }
        ...
        case "]":
            braces = (begin: "[", end: "]")
        case ">":
            guard UserDefaults.standard.bool(forKey: CEDefaultHighlightLtGtKey) else { return }
            braces = (begin: "<", end: ">")
        default: return
        }
    ...
    func setupCurrentLineUpdateTimer() {
        ...
        guard UserDefaults.standard.bool(forKey: CEDefaultHighlightCurrentLineKey) else { return }
