...
final class PrintSettingsModel: NSObject, PrintAccessoryModel {
    ...
    @Published var documentShowsLineNumber = false
    @Published var documentShowsInvisibles = false
    ...
    var body: some View {
        ...
        Form {
            ...
            Picker(String(localized: "Color", table: "PrintPanelAccessory"), selection: $model.theme) {
                Text(ThemeName.blackAndWhite).tag(ThemeName.blackAndWhite)
            ...
            Toggle(String(localized: "Print Headers and Footers", table: "PrintPanelAccessory"),
                   isOn: $model.printsHeaderAndFooter)
        ...
        .animation(.default, value: self.model.printsHeaderAndFooter)
        .formStyle(.grouped)
    }
}
