...
- Syntax highlight reguler expression patterns in the syntax style editor and the custom sort dialog.
...
- Enable “Share” button in toolbar also in the Text Only mode.
