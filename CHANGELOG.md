...
- Fix an issue in the file browser where moving an item into a folder that already contained an item with the same name could leave it pointing to the wrong location.
